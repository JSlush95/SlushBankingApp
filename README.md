...
1.  My program will use these references for their respective functionalities of emailing and encrypting.
    ...
    public static class EnvironmentVariables
    {
        ...
        public static string PrivateKey => Environment.GetEnvironmentVariable("PrivateKey", EnvironmentVariableTarget.Machine);
    }
    ```
