        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankAccounts_Users_Holder",
                        column: x => x.Holder,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssociatedAccount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_BankAccounts_AssociatedAccount",
                        column: x => x.AssociatedAccount,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeExecuted = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionRecords_BankAccounts_Recipient",
                        column: x => x.Recipient,
                        principalTable: "BankAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransactionRecords_BankAccounts_Sender",
                        column: x => x.Sender,
                        principalTable: "BankAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccounts_Holder",
                table: "BankAccounts",
                column: "Holder");

            migrationBuilder.CreateIndex(
                name: "IX_Cards_AssociatedAccount",
                table: "Cards",
                column: "AssociatedAccount");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionRecords_Recipient",
                table: "TransactionRecords",
                column: "Recipient");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionRecords_Sender",
                table: "TransactionRecords",
                column: "Sender");
